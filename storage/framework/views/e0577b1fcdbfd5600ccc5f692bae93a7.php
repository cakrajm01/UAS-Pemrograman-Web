...
<form method="POST" action="<?php echo e(route('imunisasi.update', $imunisasi->id)); ?>">
    <?php echo csrf_field(); ?>
    ...
    <a href="<?php echo e(route('imunisasi.index')); ?>" class="ml-2 text-gray-600">Batal</a>
</form>
<?php $__env->stopSection(); ?>
`

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\data-imunisasi-anak\resources\views/imunisasi/edit.blade.php ENDPATH**/ ?>